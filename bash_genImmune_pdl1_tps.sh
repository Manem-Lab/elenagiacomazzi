...
python ./Predictions/0_reg_general.py  -fs $featSelMeth_temp -local False -path /pdl1_Immune -k_max 50 -pred pdl1_tps -trainSet CHUM -genomics True -num_gen Immune