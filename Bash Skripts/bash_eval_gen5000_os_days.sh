#!/bin/bash
#SBATCH --job-name=os-eval-5000gen
#SBATCH --array=0-1
...
python ./Predictions/eval_script_refactored.py  -fs $featSelMeth_temp -local False -path /os_5000genNEW -k_max 100 -pred os_days -trainSet CHUM -genomics True -num_gen 5000