...
python ./Predictions/0_reg_general.py  -fs $featSelMeth_temp -local False -path /pfs_Immune -k_max 50 -pred pfs_days -trainSet CHUM -genomics True -num_gen Immune