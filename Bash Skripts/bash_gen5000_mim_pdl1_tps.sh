#!/bin/bash
#SBATCH --job-name=pdl1-5000gen-mim
#SBATCH --array=0
...
python ./Predictions/0_reg_general.py  -fs $featSelMeth_temp -local False -path /pdl1_5000genNEW -k_max 100 -pred pdl1_tps -trainSet CHUM -genomics True -num_gen 5000