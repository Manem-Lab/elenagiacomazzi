#!/bin/bash
#SBATCH --job-name=pfs-Immune-eval
#SBATCH --array=0-4
...
python ./Predictions/eval_script_refactored.py  -fs $featSelMeth_temp -local False -path /pfs_Immune -k_max 50 -pred pfs_days -trainSet CHUM -genomics True -num_gen Immune