#!/bin/bash
#SBATCH --job-name=pfs-eval-5000gen
#SBATCH --array=0-1
...
python ./Predictions/eval_script_refactored.py  -fs $featSelMeth_temp -local False -path /pfs_5000genNEW -k_max 100 -pred pfs_days -trainSet CHUM -genomics True -num_gen 5000