#!/bin/bash
#SBATCH --job-name=pfs-eval-1000gen
#SBATCH --array=0-1
...
python ./Predictions/eval_script_refactored.py  -fs $featSelMeth_temp -local False -path /pfs_1000genNEW -k_max 100 -pred pfs_days -trainSet CHUM -genomics True -num_gen 1000