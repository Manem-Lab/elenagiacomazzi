#!/bin/bash
#SBATCH --job-name=os-Immune-eval
#SBATCH --array=0-4
...
python ./Predictions/eval_script_refactored.py  -fs $featSelMeth_temp -local False -path /os_Immune -k_max 50 -pred os_days -trainSet CHUM -genomics True -num_gen Immune