#!/bin/bash
#SBATCH --job-name=pdl1-eval-1000gen
#SBATCH --array=0-1
...
python ./Predictions/eval_script_refactored.py  -fs $featSelMeth_temp -local False -path /pdl1_1000genNEW -k_max 100 -pred pdl1_tps -trainSet CHUM -genomics True -num_gen 1000