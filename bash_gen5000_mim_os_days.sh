#!/bin/bash
#SBATCH --job-name=os-5000gen-mim
#SBATCH --array=0
...
python ./Predictions/0_reg_general.py  -fs $featSelMeth_temp -local False -path /os_5000genNEW -k_max 100 -pred os_days -trainSet CHUM -genomics True -num_gen 5000