...
python ./Predictions/0_reg_general.py  -fs $featSelMeth_temp -local False -path /os_1000genNEW -k_max 100 -pred os_days -trainSet CHUM -genomics True -num_gen 1000