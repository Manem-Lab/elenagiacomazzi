...
def main_eval(feat_sel_method, corr_meth="spearman", random_state=42):
    ...
    if feat_sel_method == "mrmr":
        ...
        for nr_sol in nr_sol_list:
            result_discovery_chum = helper_data_load.load_csv(file_name="os_days_results_CHUM_discovery_"+feat_sel_method+str(nr_sol)+"_std_scl_1-100.csv", local=local)
    ...
    if feat_sel_method == "corr1":
        ...
        result_discovery_chum_list.append(helper_data_load.load_csv(file_name="os_days_results_CHUM_discovery_"+feat_sel_method+str(nr_sol)+"_std_scl_1-100.csv", local=local))
        ...
        nr_sol_list = [-1]
        nr_sol = nr_sol_list[0]
        result_discovery_chum_list.append(helper_data_load.load_csv("os_days_results_CHUM_discovery_"+feat_sel_method+str(nr_sol)+"_std_scl_1-100.csv", local))
