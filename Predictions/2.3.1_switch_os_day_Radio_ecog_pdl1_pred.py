...
def start_pred(data_norm, random_state, feat_sel_method, nr_sol_list):
    ...
    for nr_sol in nr_sol_list:
        ...
        bucket = 'oncotechdata'
        result_discovery_CHUM_all.to_csv(f"s3://{bucket}/ecog/results/os_days_results_CHUM_discovery_"+feat_sel_method+str(nr_sol)+"_std_scl_1-50.csv", storage_options={"client_kwargs": {'endpoint_url': ENDPOINT_URL}})
