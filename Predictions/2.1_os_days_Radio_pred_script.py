...
def start_pred(data_norm, random_state, feat_sel_method, nr_sol_list):
    ...
    for nr_sol in nr_sol_list:
        ...
        bucket = 'oncotechdata'
        result_discovery_IUCPQ_all.to_csv(f"s3://{bucket}/results/os_days_results_IUCPQ_discovery_"+feat_sel_method+str(nr_sol)+"_std_scl_1-100.csv", storage_options={"client_kwargs": {'endpoint_url': ENDPOINT_URL}})
