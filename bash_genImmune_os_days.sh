...
python ./Predictions/0_reg_general.py  -fs $featSelMeth_temp -local False -path /os_Immune -k_max 50 -pred os_days -trainSet CHUM -genomics True -num_gen Immune